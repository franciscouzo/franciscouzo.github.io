...
document.addEventListener('DOMContentLoaded', function() {
  ...
  gui.add(options, 'algorithm',
    ['Threshold', 'Random',
     'Ordered 2x2', 'Ordered 3x3', 'Ordered 4x4', 'Ordered 8x8',
     'Halftone', 'Cross', 'Void and cluster',
     'Basic error diffusion', 'Floyd–Steinberg', 'False Floyd–Steinberg',
     'Zhigang Fan', 'Shiau-Fan', 'Shiau-Fan 2',
     'Jarvis, Judice & Ninke', 'Stucki', 'Burkes', 'Atkinson',
     'Sierra', 'Sierra2', 'Sierra Lite']).name('Algorithm');
